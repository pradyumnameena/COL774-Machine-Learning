...
def main():
    new2_text = "Came here for the Holiday Lights Train Rides around Christmas time. I was pleasantly surprised that it was free when we got there and they happily take donations. For mainly running on donations, the Christmas lights set up was lovely. Although it was busy, parking was not an issue, and the wait was maybe 5 minutes. The ride itself was 20-30 minutes. Very much worth it. :)"
    new_text = "It is important to by very pythonly while you are pythoning with python. \
                All pythoners have pythoned poorly at least once."
    a = getStemmedDocuments(new2_text,True)
    print(a[6])
